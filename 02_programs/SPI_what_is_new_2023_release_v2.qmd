...
This table shows the progression of Statistical Performance Indicator (SPI) scores from 2016 to 2023. The overall score and individual scores for each of the five pillars—Data Use, Data Services, Data Products, Data Sources, and Data Infrastructure—are listed for each year. The table highlights the steady improvement in overall SPI scores, with significant gains in pillars like Data Services and Data Infrastructure, reflecting improvements in countries’ statistical capacity and the availability of modern data systems.
...
This table focuses on the development of data services, covering indicators like e-GDDS subscription, machine readability, and download options. It reflects how countries have advanced in providing accessible, standardized, and open data, with noticeable improvements in machine-readable formats, non-proprietary formats of data, and microdata catalogues, particularly after 2017.
