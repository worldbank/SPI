...
spi_index_df <- spi_index_df %>%
  ...
  mutate(across(c("SPI.D2.1.GDDS","SPI.D2.4.NADA","SPI.D4.1.1.POPU","SPI.D4.1.2.AGRI","SPI.D4.1.3.BIZZ","SPI.D4.1.4.HOUS","SPI.D4.1.5.AGSVY",
                ...
                ~if_else((is.na(.) & (country %in% oecd_country_df$name)),1,.)                )) %>% #fill in the missing values for OECDs with 1s because by participating in OECD these countries have this
