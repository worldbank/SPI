...
#Population Censuses
cs1_df <-census_fun('D4.1.1.CEN.POPU', 'POPU.CENSUS') %>%
...
```{r 4_SOPC, fig.height=7, fig.width=9, message=FALSE, warning=FALSE}
#####
# Google
#####
#google mobility
...
#Drop certain indicators that don't make cut
spi_index_df <- spi_index_df %>%
  select(-starts_with('SPI.D1'), -SPI.5.3.DISK)
...
index_1 <- spi_index_df %>%
  ...
  mutate(across(c("SPI.D2.1.GDDS","SPI.D2.4.NADA","SPI.D4.1.1.POPU","SPI.D4.1.2.AGRI","SPI.D4.1.3.BIZZ","SPI.D4.1.4.HOUS","SPI.D4.1.5.AGSVY",
                  ...
                  "SPI.D5.2.1.SNAU", "SPI.D5.2.2.NABY", "SPI.D4.2.4.LBR", "SPI.5.1.DILG", "SPI.D5.2.1.SNAU","SPI.D5.2.2.NABY",                
                ...
                ~if_else((is.na(.) & income=="High income"),1,.)                )) %>% #fill in the missing values for HICs with 1s
...
spi_mapper('index_1','SPI.INDEX','Overall SPI using Simple Index Averaging Over All Indicators.  Equal Weight for Each Indicator.  Fill Forward/Ignore Missing Values')
