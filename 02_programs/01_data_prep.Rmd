...
### AKI 1.5.1, 1.5.9, 1.5, 1.5.11, 1.5.12, 1.5.13
...
## Scoring Approach
  ...
  3. Combine the resulting data into a single set of indicators for use in the Statistical Performance Indicators dashboard and index
...
un_sdg_df <- read_csv(paste(raw_dir,'/3_DP/SPI_D3_UNSD_data.csv',sep=""))
...
spi_mapper('D5.1_DILG_map', 'RAW.5.1.DILG', 'National statistical legislation complies with United Nations Fundamental Principles of Statistics. Source: Paris21')
...
spi_mapper('D5.5_DIFI_map', 'RAW.5.5.DIFI', 'Statistical plan fully funded. Source: Paris21')
