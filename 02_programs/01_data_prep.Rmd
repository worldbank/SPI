...
spi_mapper('un_sdg_map','SPI.D3.1','Goal 1: No Poverty')
spi_mapper('un_sdg_map','SPI.D3.2','Goal 2: No Hunger')
spi_mapper('un_sdg_map','SPI.D3.3','Goal 3: Good Health and Well-being')
spi_mapper('un_sdg_map','SPI.D3.4','Goal 4: Quality Education  ')
spi_mapper('un_sdg_map','SPI.D3.5','Goal 5: Gender Equality ')
spi_mapper('un_sdg_map','SPI.D3.6','Goal 6: Clean Water and Sanitation ')
spi_mapper('un_sdg_map','SPI.D3.7','Goal 7: Affordable and Clean Energy')
spi_mapper('un_sdg_map','SPI.D3.8','Goal 8: Decent Work and Economic Growth  ')
spi_mapper('un_sdg_map','SPI.D3.9','Goal 9: Industry, Innovation and Infrastructure ')
spi_mapper('un_sdg_map','SPI.D3.10','Goal 10: Reduced Inequality   ')
spi_mapper('un_sdg_map','SPI.D3.11','Goal 11: Sustainable Cities and Communities')
spi_mapper('un_sdg_map','SPI.D3.12','Goal 12: Responsible Consumption and Production   ')
spi_mapper('un_sdg_map','SPI.D3.13','Goal 13: Climate Action')
spi_mapper('un_sdg_map','SPI.D3.14','Goal 14: Life Below Water')
spi_mapper('un_sdg_map','SPI.D3.15','Goal 15: Life on Land')
spi_mapper('un_sdg_map','SPI.D3.16','Goal 16: Peace and Justice Strong Institutions')
spi_mapper('un_sdg_map','SPI.D3.17','Goal 17: Partnerships to achieve the Goal  ')
