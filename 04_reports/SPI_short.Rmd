...
(gdp_spi + hci_spi)   +
  plot_annotation(
    title = 'SPI Overall Scores strongly related to GDP per capita and Human Capital Index.',
    subtitle='Plot of SPI Index on Human Capital Index and GDP per capita',
