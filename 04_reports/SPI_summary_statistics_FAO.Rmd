...
Closer Look at Specific Indicators
...
spi_mapper2 <- function(data, indicator, title) {
 ...
 indicator<-indicator
  ...
  p1<-ggplot() +
    ...
    labs(
      title=str_wrap(title,100),
      caption = 'Source: Statistical Performance Indicators'
    ) + 
    theme(
          #legend.position = "top",
...
.center2[
```{r hunger, echo=FALSE, message=FALSE, warning=FALSE, fig.height=14, fig.width=14}
spi_mapper2('SPI', 'SPI.D3.2.HNGR', 'SDG 2: Data Availability from UNSD SDG Database')
...
---
.center2[
```{r agcen, echo=FALSE, message=FALSE, warning=FALSE, fig.height=14, fig.width=14}
spi_mapper2('SPI', 'SPI.D4.1.2.AGRI', 'Agricultural Census Availability in Past 20 Years')
...
---
.center2[
```{r agsvy, echo=FALSE, message=FALSE, warning=FALSE, fig.height=14, fig.width=14}
spi_mapper2('SPI', 'SPI.D4.1.5.AGSVY', 'Agricultural Survey in Past 10 Years')
