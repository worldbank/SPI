...
odin_overperformers_plot <- odin_overperformers_plot %>%
  ...
  ggtitle("Difference in Country Ranks Between ODIN and SPI Overall Scores for 2018",
...
odin_overperformers_df_full %>%
  ...
  arrange(-SPI.INDEX) %>%
  flextable() %>%
  add_header_lines('SPI and ODIN Country Rankings in 2018')
