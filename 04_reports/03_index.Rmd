 ...
 indicator<-indicator
  ...
  SPI_map <- map_df %>%
    mutate(spi_groups=case_when(
      between(data_available, spi_groups_quantiles[5],100) ~ "Advanced-high",
      between(data_available, spi_groups_quantiles[4],spi_groups_quantiles[5]) ~ "Advanced-low",
      between(data_available, spi_groups_quantiles[3],spi_groups_quantiles[4]) ~ "Intermediate-high",
      between(data_available, spi_groups_quantiles[2],spi_groups_quantiles[3]) ~ "Intermediate-low",
      between(data_available, spi_groups_quantiles[1],spi_groups_quantiles[2]) ~ "Emerging-high",
      between(data_available, 0,spi_groups_quantiles[1]) ~ "Emerging-low"
