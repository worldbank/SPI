...
Table. Relationship between $1.90 Poverty Headcount Ratio and SPI scores using data from 2016-2022.
...
Table. Relationship between Gini Coefficient and SPI scores using data from 2016-2022.
...
The data on 10 year dollar denominated government bond spreads was collected from Bloomberg from the period 2015 to 2022 for `r country_num_bonds`.^[The countries where bond spreads were collected includes `r country_list_bonds`.]  These countries had data available from Bloomberg over the period.
